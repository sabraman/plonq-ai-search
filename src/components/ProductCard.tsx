...
export function ProductCard({
  ...
  return (
    ...
    <div
      ...
      className="flex h-full w-full cursor-pointer flex-col justify-between rounded-[20px] bg-[#F6F5F8] p-3 text-left shadow-sm transition-shadow hover:shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500"
    >
      {/* Header */}
      ...
      {/* Image */}
      <div className="relative mb-2 flex aspect-[3/4] w-full items-center justify-center">
        <Image
      ...
      <div className="mb-3 flex-grow">
        <h3 className="mb-2 text-sm font-bold leading-tight text-gray-900">
          {product.flavor}
        </h3>
